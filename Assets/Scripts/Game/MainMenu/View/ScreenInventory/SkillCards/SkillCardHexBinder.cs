...
{
    public class SkillCardHexBinder : MonoBehaviour
    {
        ...
        public void Bind(SkillCardViewModel viewModel)
        {
            ...
            viewModel.EpicLevel
                .Subscribe(newValue => epicImage.sprite = imageManager.GetEpicSkillLevel(newValue))
                .AddTo(ref d);
            viewModel.Level
                .Subscribe(newValue => { levelText.text = $"{newValue}"; })
                .AddTo(ref d);
